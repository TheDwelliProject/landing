        ...
        <Container>
          <div className="max-w-[560px] mx-auto sm:mx-0">
            ...
            <p className="mt-6 text-[16px] leading-[1.55] text-white/65 max-w-[460px]">
              The real list of communities you administer will land here in a
              later stage. For now this is the post-auth destination so the
              middleware has something to gate on.
            </p>
