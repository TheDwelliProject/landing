        ...
        <Container>
          <div className="max-w-[560px] mx-auto sm:mx-0">
            ...
            <p className="mt-6 text-[16px] leading-[1.55] text-white/65 max-w-[460px]">
              The real queue of pending community applications lands here in a
              later stage. For now this is the gated destination for users with
              the <code className="text-white/85">superadmin</code> claim.
            </p>
