	...
	const faqItems = [
		{
			...
			answer: "Dwelli is a property management platform that helps landlords manage their properties and renters find their next home.",
		},
		{
			question: "How can I list my property on Dwelli?",
			answer: "To list your property on Dwelli, you need to create an account. Once you have an account, you can list your property by providing the necessary details.",
		},
		{
			question: "What is the cost of using Dwelli?",
			answer: "Dwelli is free to use for renters. However, landlords will be charged a fee for using the platform.",
		},
		{
			question: "How can I contact Dwelli?",
			answer: "You can contact Dwelli by sending us a message through our contact form. We will get back to you as soon as possible.",
		},
	];
	...
	return (
		<div className="flex w-full flex-col items-center py-12" id="faq">
			...
			<p className="mt-4 w-5/6 sm:w-2/3 text-center tracking-tight text-zinc-500">
				We aim to address the most common questions you may have.
				However, if you have any further inquiries, please don’t
