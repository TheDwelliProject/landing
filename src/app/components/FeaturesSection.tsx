...
export default function FeaturesSection() {
  return (
    <div className="flex w-full flex-col items-center py-16" id="residents">
      ...
      {/* For Residents*/}
      <div className="mt-24 sm:mt-48 flex w-5/6 flex-col items-center gap-4 text-center" id="owners">
        <h2 className="text-5xl tracking-tight text-zinc-800">For Property Owners & Managers</h2>
        <p className="text-zinc-500">Help me here</p>
        <div className="mt-16 flex flex-col gap-8 text-left sm:flex-row">
          <div className="grow basis-0">
            <div className="bg-zinc-50 w-full rounded-3xl">
